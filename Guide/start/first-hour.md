...
description: Type or speak. Voice goes through a wake gate — it listens continuously but.
---
...
The first time you ask it to write a file or run a command, it will stop and
ask. That prompt is the product working, not the
product being cautious. You can widen the defaults later; the point is that
widening them is a decision you make rather than one made for you.
