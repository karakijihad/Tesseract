---
title: Setting up
description: "Install covers installing and getting a first conversation working. This file is the rest: what each key does, what happens when one is missing, and…"
---

<!-- Rendered from SETUP.md at the repository root by
     tesseract/scripts/generate_guide.py. Edit that file, not this
     one; CI regenerates this page and fails if it differs. -->

[Install](/start/install/) covers installing and getting a first conversation working. This file is the rest: what each key does, what happens when one is missing, and how to point TESSERACT at a different model.
