/**
 * Minimal 3D simplex noise — single octave, used for curl turbulence.
...
/** 3-component noise displacement using offset evaluations (fast, visually organic) */
export function noiseDisplacement(
  ...
  return [
    simplex3(sx + time, sy + 31.4, sz + 97.2),
    simplex3(sx + 152.7, sy + time, sz + 43.8),
    simplex3(sx + 68.1, sy + 219.5, sz + time),
  ];
}
