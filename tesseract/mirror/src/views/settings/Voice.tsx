  ...
  return (
    <section className="settings-section">
      ...
      <div className="settings-hint t-meta">
        ...
        <code>
          voice.tts.settings.api.google.gemini_flash_tts.synthesis_presets
        </code>
        ) — edits there trigger the config watcher and the next utterance picks
        them up. Saving timbre also reloads the voice runtime.
      </div>
      ...
      <div className="voice-settings-row">
        ...
        <Hint label="Cloud provider: Gemini Flash TTS (single GOOGLE_API_KEY).">
          <span className="voice-settings-provider t-meta">
            Gemini Flash TTS
          </span>
        </Hint>
      </div>
