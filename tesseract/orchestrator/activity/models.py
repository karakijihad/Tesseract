...
class ActivityRecord:
    ...
    owner_principal: str = ""
    # Mirrors `Lane.shared_with`. Without it the enumeration path knows only
    # about owners, so a lane deliberately shared with a second principal is
    # invisible to exactly the client it was shared with.
