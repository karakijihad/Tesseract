...
USER_DIRS = (
    ...
    "memory-store", "vault", "workspace", "tars-workshop", "sessions",
...
# a refusal.
MACHINE_DIRS = (
    "venv", "EBWebView", "browser", "run", "tars_controller", "scheduler",
    "controller",
)
MACHINE_FILES = (
...
LOGS_TO_RUNTIME = (
    ...
    "tars-controller-console.log", "tars-controller.log",
    "cost-tracking.jsonl",
)

# Template trees seeded into home/, used to pre-populate the phase-5 manifest.
_TEMPLATE_TREES = ("config", "workspace", "memory-store", "vault", "tars-workshop")
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--root", type=Path, default=None, help="install root to migrate")
